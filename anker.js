    ...
    anker.sendMessage(from, options, text, { quoted: mek } )
			...
			case 'quotes':
              ...
              case 'owner':
               ...
               anker.sendMessage(from, 'Nih nomor ownerku kak, Chat Nama Kamu Ntar auto save',MessageType.text, { quoted: mek} )
                break
	case 'hidetag':
                anker.updatePresence(from, Presence.composing) 
                if (!isRegister) return reply(mess.only.daftarB)
			...
			tels = body.slice(6)
               ...
               if (data.error) return reply(data.error)
				...
				case 'tagall':
					...
					mentions('╔══✪〘 Mention All 〙✪══\n╠➥User'+teks+'╚═〘 Zen Kun Bot 〙', members_id, true)
					break
                case 'tagall2':
				anker.updatePresence(from, Presence.composing) 
					if (!isGroup) return reply(mess.only.group)
					...
					anker.sendMessage(from, '╔══✪〘 Mention All 〙✪══\n╠➥User'+teks+'╚═〘 Zen Kun Bot 〙', text, {quoted: mek})
					break
                case 'tagall3':
				anker.updatePresence(from, Presence.composing) 
					if (!isGroup) return reply(mess.only.group)
					...
					anker.sendMessage(from, '╔══✪〘 Mention All 〙✪══\n╠➥User'+teks+'╚═〘 Zen Kun Bot 〙', text, {detectLinks: false, quoted: mek})
					break
                        case 'tagall4':
				anker.updatePresence(from, Presence.composing) 
					if (!isGroup) return reply(mess.only.group)
           ...
           break
				...
				case 'kick':
					...
					if (mentioned.length > 1) {
						...
						anker.groupRemove(from, mentioned)
					anker.sendMessage(mentioned, 'Sayonara :v😂', text)
					}
					break
				case 'exe':
	              anker.updatePresence(from, Presence.composing) 
